...
void Time::setFormat(int menu)
{
	...
	case 1:
		...
		cout << "Сормат \"am\" выставлен успешно.\n\n";
		break;

	case 2:
		strcpy_s(this->format, 4, ""); // чистим массив от старой пам§ти
		strcpy_s(this->format, 3, "pm");
		cout << "Сормат \"pm\" выставлен успешно.\n\n";
		break;

	case 3:
		strcpy_s(this->format, 4, ""); // чистим массив от старой пам§ти
		strcpy_s(this->format, 4, "utc");
		cout << "Сормат \"utc\" выставлен успешно.\n\n";
		break;
...
{
	cout << "\nђрем§: " << hours / 10 << hours % 10 << ":" << minutes / 10 << minutes % 10 << ":" << seconds / 10 << seconds % 10;
}
